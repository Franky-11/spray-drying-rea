...
def build_default_input_dto() -> StationaryInputDTO:
    ...
    return StationaryInputDTO(
        ...
        atomization_zone_length_m=0.0,
        atomization_zone_exposure_factor=1.0,
        secondary_exposure_zone_length_m=0.0,
        secondary_exposure_zone_factor=1.0,
        effective_gas_humidity_mode="off",
        humidity_bias_zone_length_m=0.0,
        humidity_bias_zone_target_rh=0.0,
        humidity_bias_zone2_length_m=0.0,
        humidity_bias_zone2_target_rh=0.0,
        enable_material_retardation_add=False,
        x_b_model="lin_gab_langrish_blend_rh",
        x_b_blend_langrish_weight=0.5,
        x_b_blend_langrish_weight_base=0.02,
        x_b_blend_langrish_weight_rh_coeff=2.0,
...
def _dto_from_stationary_input(model_input: StationarySMPREAInput) -> StationaryInputDTO:
    ...
    return StationaryInputDTO(
        ...
        atomization_zone_length_m=model_input.atomization_zone_length_m,
        atomization_zone_exposure_factor=model_input.atomization_zone_exposure_factor,
        secondary_exposure_zone_length_m=model_input.secondary_exposure_zone_length_m,
        secondary_exposure_zone_factor=model_input.secondary_exposure_zone_factor,
        effective_gas_humidity_mode=model_input.effective_gas_humidity_mode,
        humidity_bias_zone_length_m=model_input.humidity_bias_zone_length_m,
        humidity_bias_zone_target_rh=model_input.humidity_bias_zone_target_rh,
        humidity_bias_zone2_length_m=model_input.humidity_bias_zone2_length_m,
        humidity_bias_zone2_target_rh=model_input.humidity_bias_zone2_target_rh,
        enable_material_retardation_add=model_input.enable_material_retardation_add,
        x_b_model=model_input.x_b_model,
        x_b_blend_langrish_weight=model_input.x_b_blend_langrish_weight,
        x_b_blend_langrish_weight_base=model_input.x_b_blend_langrish_weight_base,
        x_b_blend_langrish_weight_rh_coeff=model_input.x_b_blend_langrish_weight_rh_coeff,
...
def _dto_to_stationary_input(input_dto: StationaryInputDTO) -> StationarySMPREAInput:
    ...
    return StationarySMPREAInput(
        ...
        atomization_zone_length_m=input_dto.atomization_zone_length_m,
        atomization_zone_exposure_factor=input_dto.atomization_zone_exposure_factor,
        secondary_exposure_zone_length_m=input_dto.secondary_exposure_zone_length_m,
        secondary_exposure_zone_factor=input_dto.secondary_exposure_zone_factor,
        effective_gas_humidity_mode=input_dto.effective_gas_humidity_mode,
        humidity_bias_zone_length_m=input_dto.humidity_bias_zone_length_m,
        humidity_bias_zone_target_rh=input_dto.humidity_bias_zone_target_rh,
        humidity_bias_zone2_length_m=input_dto.humidity_bias_zone2_length_m,
        humidity_bias_zone2_target_rh=input_dto.humidity_bias_zone2_target_rh,
        enable_material_retardation_add=input_dto.enable_material_retardation_add,
        x_b_model=input_dto.x_b_model,
        x_b_blend_langrish_weight=input_dto.x_b_blend_langrish_weight,
        x_b_blend_langrish_weight_base=input_dto.x_b_blend_langrish_weight_base,
        x_b_blend_langrish_weight_rh_coeff=input_dto.x_b_blend_langrish_weight_rh_coeff,
...
def _series_point_from_row(row: pd.Series) -> SimulationSeriesPointDTO:
    return SimulationSeriesPointDTO(
        ...
        x_b=float(row["x_b"]),
        psi=float(row["psi"]),
        axial_exposure_factor=float(row["axial_exposure_factor"]),
        combined_contact_exposure_factor=float(row["combined_contact_exposure_factor"]),
        RH_eff_pct=100.0 * float(row["RH_eff"]),
        Y_eff=float(row["Y_eff"]),
        humidity_bias_active=bool(row["humidity_bias_active"] > 0.5),
