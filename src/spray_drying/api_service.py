...
def build_default_input_dto() -> StationaryInputDTO:
    ...
    return StationaryInputDTO(
        ...
        x_b_blend_kockel_weight=0.5,
        x_b_blend_kockel_weight_base=0.02,
        x_b_blend_kockel_weight_rh_coeff=2.0,
...
def _dto_from_stationary_input(model_input: StationarySMPREAInput) -> StationaryInputDTO:
    ...
    return StationaryInputDTO(
        ...
        x_b_blend_kockel_weight=model_input.x_b_blend_kockel_weight,
        x_b_blend_kockel_weight_base=model_input.x_b_blend_kockel_weight_base,
        x_b_blend_kockel_weight_rh_coeff=model_input.x_b_blend_kockel_weight_rh_coeff,
...
def _dto_to_stationary_input(input_dto: StationaryInputDTO) -> StationarySMPREAInput:
    ...
    return StationarySMPREAInput(
        ...
        x_b_blend_kockel_weight=input_dto.x_b_blend_kockel_weight,
        x_b_blend_kockel_weight_base=input_dto.x_b_blend_kockel_weight_base,
        x_b_blend_kockel_weight_rh_coeff=input_dto.x_b_blend_kockel_weight_rh_coeff,
